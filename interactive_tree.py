...
"""
IN ORDER TO USE THE INTERACTIVE TREE TOU NEED TO HAVE A PRINT METHOD IN YOUR AVLTree CLASS AND NAME IT
printt. ALTERNATIVELY, YOU CAN CHANGE THE CODE OF THIS FILE TO FIT WITH THE NAME OF YOUR PRINT METHOD.
IF YOU DON'T HAVE A PRINT METHOD IN YOUR AVLTree CLASS, COPY THE FOLLOWING CODE TO YOUR CLASS:
...
def interactive_tree():
    T = AVLTree()
    while True:
        choice = input("choose an operation you want to do with your AVLTree from the following: \n \
        ...
        if choice == "exit":
            ...
            if T.empty():
                print("your AVLTree is empty")
            else:
                print("your AVLTree is not empty")
            ...
            lst = input(
                "enter a sequence of values you want to create a new AVLTree that will be concatenated to \n\
            ...
            print("the AVLTree that had been concatenated to your list is: ")
            L.printt()
            print(L.listToArray())
            T.concat(L)
            ...
            print("please enter a valid input")
        ans = input(
            "enter 'yes' if you want to print your AVLTree\n\
            enter your choice here:  ")
        if ans == "yes":
            T.printt()
            print(T.listToArray())
